...
in ''
  ...
  hi Error         guifg=${c.surface} guibg=${c.error} gui=NONE guisp=NONE
  ...
  hi Folded        guifg=${c.secondary} guibg=${c.surface} gui=NONE guisp=NONE
  hi IncSearch     guifg=${c.on_primary} guibg=${c.primary} gui=NONE guisp=NONE
  hi Italic        guifg=${c.on_surface} guibg=${c.surface} gui=italic guisp=NONE
  hi Macro         guifg=${c.error} guibg=${c.surface} gui=NONE guisp=NONE
  hi MatchParen    guifg=${c.on_primary} guibg=${c.primary_container} gui=NONE guisp=NONE
  ...
  hi Search        guifg=${c.on_primary} guibg=${c.primary} gui=NONE guisp=NONE
  hi Substitute    guifg=${c.on_secondary} guibg=${c.secondary} gui=NONE guisp=NONE
  ...
  hi WildMenu      guifg=${c.on_primary} guibg=${c.primary} gui=NONE guisp=NONE
  ...
  hi Keyword       guifg=${c.secondary} guibg=NONE gui=NONE guisp=NONE
  ...
  hi TSProperty            guifg=${c.outline} guibg=NONE gui=NONE guisp=NONE
  ...
  hi TSString              guifg=${c.outline} guibg=NONE gui=NONE guisp=NONE
  ...
  hi TSSymbol              guifg=${c.outline} guibg=NONE gui=NONE guisp=NONE

{
  ...
  xdg = let
    TermLaunch = ''${lib.getExe pkgs.handlr-regex} launch "x-scheme-handler/terminal" -- -e'';
    mimeAppsList = {
  ...
  in {
    desktopEntries = {
      nvim = {
        ...
        icon = "nvim";
        mimeType = builtins.attrNames mimeAppsList;
        terminal = false;
        type = "Application";
    ...
    mimeApps.defaultApplications = mimeAppsList;
  };
}
